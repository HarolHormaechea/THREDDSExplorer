...
class THREDDSExplorer:
    ...
    def __init__(self, iface):
        ...
        self.dlg = Visor_UI.Visor()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr('THREDDS Visor')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar('THREDDS Visor')
        self.toolbar.setObjectName('THREDDS Visor')
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr('Access THREDDS server list'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr('THREDDS Explorer Plugin'),
                action)
