...
class Controller(QObject):
    ...
    def setUpAnimation(self, animationLayerList):
        ...
        for animationLayer in otherLayers:
            if animationLayer.getAnimationLegendGroups():
                ...
                self.updateTimeRange(list(animationLayer.getAnimationData().frameData.keys()))
    ...
    def cancelLoad(self):
        try:
            for item in list(self.threadsInUse.keys()):
    ...
    def initializeAnimator(self, animationLayerObject):
        ...
        self.updateTimeRange(list(animationData.frameData.keys())) #We update the list of times covered by our frames
    ...
    def createLayerGroup(self, animationLayerObject, groupName):
        layerList = list(animationLayerObject.getAnimationData().frameData.values())
