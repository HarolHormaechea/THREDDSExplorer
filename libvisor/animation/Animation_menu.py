...
class Ui_dockAnimationWidget(object):
    def setupUi(self, dockAnimationWidget):
        ...
        self.tableLayerList.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tableLayerList.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tableLayerList.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.loopCheckbox)
        self.labelFrameRate = QtWidgets.QLabel(self.dockWidgetContents)
        self.labelFrameRate.setObjectName(_fromUtf8("labelFrameRate"))
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.labelFrameRate)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.frameRateSpinbox)
        self.labelTimeFrame = QtWidgets.QLabel(self.dockWidgetContents)
        self.labelTimeFrame.setObjectName(_fromUtf8("labelTimeFrame"))
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.labelTimeFrame)
